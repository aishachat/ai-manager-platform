-- 🚨 ИСПРАВЛЕНИЕ ОСТАВШИХСЯ ПРОБЛЕМНЫХ ПОЛИТИК
-- Исправляем политики без WHERE условий

-- ============================================
-- ИСПРАВЛЯЕМ ПОЛИТИКИ БЕЗ УСЛОВИЙ
-- ============================================

-- assistants - исправляем SELECT/UPDATE/DELETE
...
-- autoswitch_settings - исправляем SELECT/UPDATE/DELETE
...
-- chat_messages - исправляем SELECT/UPDATE/DELETE
...
-- conversations - исправляем SELECT/UPDATE/DELETE
...
-- dialogs - исправляем SELECT/UPDATE/DELETE
...
-- knowledge_chunks - исправляем SELECT/UPDATE/DELETE
...
-- knowledge_sources - исправляем SELECT/UPDATE/DELETE
...
-- projects - исправляем SELECT/UPDATE/DELETE
...
-- telegram_settings - исправляем SELECT/UPDATE/DELETE
...
-- user_niches - исправляем SELECT/UPDATE/DELETE
...
-- users - исправляем SELECT/UPDATE/DELETE
...
-- widget_development_settings - исправляем SELECT/UPDATE/DELETE
