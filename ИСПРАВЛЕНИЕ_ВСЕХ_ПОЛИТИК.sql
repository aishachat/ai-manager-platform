-- 🚨 КРИТИЧЕСКОЕ ИСПРАВЛЕНИЕ: Добавляем WHERE условия для всех политик
-- Функция get_user_project_id() возвращает null - нужно исправить все политики

-- ============================================
-- 1. ИСПРАВЛЯЕМ SELECT/UPDATE/DELETE ПОЛИТИКИ
-- ============================================

-- assistants - добавляем WHERE условия
...
-- autoswitch_settings - добавляем WHERE условия
...
-- chat_messages - добавляем WHERE условия
...
-- conversations - добавляем WHERE условия
...
-- dialogs - добавляем WHERE условия
...
-- knowledge_chunks - добавляем WHERE условия
...
-- knowledge_sources - добавляем WHERE условия
...
-- projects - добавляем WHERE условия
...
-- telegram_settings - добавляем WHERE условия
...
-- user_niches - добавляем WHERE условия
...
-- widget_development_settings - добавляем WHERE условия
