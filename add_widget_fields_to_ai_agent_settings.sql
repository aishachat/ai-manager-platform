-- Добавление полей настроек виджета в существующую таблицу ai_agent_settings
-- Выполните этот скрипт в Supabase SQL Editor

-- 1. Добавление полей настроек виджета в таблицу ai_agent_settings
...
CREATE INDEX IF NOT EXISTS idx_ai_agent_settings_widget_mode ON public.ai_agent_settings(widget_mode);

-- 3. Обновление существующих записей значениями по умолчанию (если нужно)
